...
$(call inherit-product-if-exists, vendor/TCT/California/California-vendor.mk)

LOCAL_PATH := device/TCT/California
...
PRODUCT_DEFAULT_LOCALE := es-US
PRODUCT_NAME := full_California

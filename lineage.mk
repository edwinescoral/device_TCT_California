# Release name
PRODUCT_RELEASE_NAME := California

# Inherit some common CM stuff.
$(call inherit-product, vendor/cm/config/common_full_phone.mk)

# Inherit device configuration
$(call inherit-product, device/TCT/California/device_California.mk)
...
PRODUCT_NAME := lineage_California
PRODUCT_BRAND := TCT
PRODUCT_MODEL := ALCATEL ONETOUCH 6012A
